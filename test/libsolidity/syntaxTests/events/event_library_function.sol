...
// TypeError 9553: (345-348): Invalid type for argument in function call. Invalid implicit conversion from f() to function () external requested. Special functions can not be converted to function types.
