...
// TypeError 9553: (582-589): Invalid type for argument in function call. Invalid implicit conversion from BUILTIN:36 () view returns (uint256) to function () pure external returns (uint256) requested. Special functions can not be converted to function types.
